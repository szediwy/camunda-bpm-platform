...
public class RemovalTimeStrategyEndTest extends AbstractRemovalTimeTest {
  ...
  /**
   * Test excluded on MariaDB and CRDB for now since it is failing randomly there.
   * See CAM-13291 for details.
   */
  @Test
  @RequiredDatabase(excludes = {DbSqlSessionFactory.MARIADB, DbSqlSessionFactory.CRDB})
